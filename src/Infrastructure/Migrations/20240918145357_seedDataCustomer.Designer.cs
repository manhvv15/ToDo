...
namespace ToDo.Infrastructure.Migrations
{
    ...
    [Migration("20240918145357_seedDataCustomer")]
    partial class seedDataCustomer
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDo.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("950bdef2-1ab1-41c7-be60-435dd030f323"),
                            Address = "Nam Dinh",
                        ...
                        new
                        {
                            Id = new Guid("3e1b0512-7046-4369-8ec0-38e1224fabc1"),
                            Address = "Ha Noi",
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            LastModified = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Tri",
            ...
            modelBuilder.Entity("ToDo.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("150aeacd-1db8-4e01-9302-0beebcb67864"),
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("7fc8cc8c-78fa-493f-909c-2b02ca0f848a"),
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("72f380ce-a322-47b9-a8de-3c00e2fd834f"),
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("2f86287a-4c97-48eb-9d91-8c18dda57bf2"),
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        new
                        {
                            Id = new Guid("ed7e1efb-988d-4008-8cce-22c564eed336"),
                            Created = new DateTimeOffset(new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("ToDo.Domain.Entities.Order", b =>
                {
                    b.HasOne("ToDo.Domain.Entities.Customer", "Customers")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("ToDo.Domain.Entities.OrderDetail", b =>
                {
                    b.HasOne("ToDo.Domain.Entities.Order", "Orders")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ToDo.Domain.Entities.Product", "Products")
                        .WithMany("OrderDetails")

...
using ToDo.Application.TodoLists.Commands.UpdateTodoList;
using ToDo.Domain.Entities;

namespace ToDo.Application.FunctionalTests.TodoLists.Commands;
...
public class UpdateTodoListTests : BaseTestFixture
{
    ...
    {
        var command = new UpdateTodoListCommand { Title = "New Title" };
